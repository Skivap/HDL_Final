...
HD_PWD='C:/Users/User/Documents/College/LDL/FinalProject/neural_network_tb/neural_network_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nn_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nn_tb.tcl
